...
export default function Signup() {
  ...
  const submitHandler = async(data)=>{
   ...
   try {
    const responce = await  axiosInstance.post("/user/signup" , {
       email :data.email,
  ...
  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Sign </h2>
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p className="mt-10 text-center text-sm/6 text-gray-500">
          A member?
          <a href="#" className="font-semibold text-indigo-600 hover:text-indigo-500"><Link to="/login">Login Account</Link></a>
        </p>
  </div>
